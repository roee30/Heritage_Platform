...
value sheets = (* cascading style sheets data *)
  ...
  ; ("span",Alphabet); ("span",Deva); ("span",Devared_)
  ; ("span",Red_); ("span",Roma16o); ("span",Magenta_); ("span",Blue_)
  ; ("span",Green_); ("span",Latin12); ("span",Latin16); ("span",Roma16)
