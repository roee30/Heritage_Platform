...
(* This segmenter is inspired from module Segmenter, but discriminates
among solutions according to probability ranks of padas, filtering the
best solutions in various modes. This improvement is the work of Sriram. *)
...
(* used by Interface : [Viccheda = Segment Phases Machine Segment_control] 
      where [Machine = Dispatch Transducers Lemmas Lexer_control] 
