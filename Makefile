...
PLATFORM=Station# Computer or Station -- no blank character in such strings
# PLATFORM=Simputer# Amida Simputer handheld device - historical

TRANSLIT=VH# Transliteration scheme VH, KH or WX
LEXICON=SH# Lexicon toggle default 
DISPLAY=roma# Default display font deva or roma

# Main directory, where the sanskrit tools are installed
SKTINSTALLDIR=/Users/huet/Sanskrit/Heritage_Platform/# To be set at configuration time 
